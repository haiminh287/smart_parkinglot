...
def test_conversation_router_prefix():
    ...
    assert (
        router.prefix == "/chatbot/conversations"
...
def test_preferences_router_prefix():
    ...
    assert (
        router.prefix == "/chatbot/preferences"
...
def test_notifications_router_prefix():
    ...
    assert (
        router.prefix == "/chatbot/notifications"
...
async def test_chat_endpoint_registered(client: AsyncClient):
    ...
    ), "POST /chatbot/chat/ returned 404 — route not registered"
